...
![機器學習五步驟流程圖，第二階段「建立資料集」被標示出來。](img-001)
...
![機器學習專案中各階段時間佔比示意圖，資料準備佔了絕大部分。](img-002)
...
![多種資料視覺化圖表的組合示意圖，包含長條圖、折線圖與圓餅圖等。](img-004)
...
[
  {
    "id": "img-001",
    "references_manifest_caption": "用機器學習解決問題的第二步驟：建立資料集",
    "why_used": "在文章開頭定位本篇在五步驟流程中的位置，讓讀者知道「建立資料集」是第二步。",
    "agent_match_hint": "機器學習五步驟的流程示意圖，其中第二個階段「建立資料集」被特別標示或凸顯。"
  },
  {
    "id": "img-002",
    "references_manifest_caption": "資料集準備與前處理佔據機器學習專案的大量時間",
    "why_used": "支撐「資料準備佔了將近 80% 時間、其他步驟只佔 20%」這個數據的段落。",
    "agent_match_hint": "呈現時間佔比的圖表（圓餅圖或長條圖），資料準備／前處理的比例明顯大於其他階段。"
  },
  {
    "id": "img-003",
    "references_manifest_caption": "機器學習中資料集的準備包含四個步驟",
    "why_used": "帶出建立資料集底下的四個階段，作為後面四個小節的總覽。",
    "agent_match_hint": "四個步驟的流程示意圖，依序列出 Data Collection、Data Inspection、Summary Statistics、Data Visualization。"
  },
  {
    "id": "img-004",
    "references_manifest_caption": "透過多種圖表進行資料視覺化 [source: FineReport]",
    "why_used": "支撐資料視覺化小節，示範資料轉成圖表後的樣子。",
    "agent_match_hint": "由多張不同類型圖表組成的儀表板畫面，包含長條圖、折線圖、圓餅圖等。"
  }
]
```
